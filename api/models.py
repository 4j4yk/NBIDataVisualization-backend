...
class Event(models.Model):
    ...
    navigationControl = models.CharField(max_length=1,blank=True)
    ...
    strucutreOpenPostedClosed = models.CharField(max_length=1,blank=True)
    ...
    superstructure = models.CharField(max_length=1,blank=True)
    substructure = models.CharField(max_length=1,blank=True)
    channelChannelProtection = models.CharField(max_length=1,blank=True)
    culverts = models.CharField(max_length=1,blank=True)
    ...
    structuralEvaluation = models.CharField(max_length=1,blank=True)
    deckGeometry = models.CharField(max_length=1,blank=True)
    underclearVerticalHorizontal = models.CharField(max_length=1,blank=True)
    bridgePosting = models.IntegerField(blank=True, null=True)
    waterwayAdequacy = models.CharField(max_length=1,blank=True)
    approachRoadwayAlignment = models.CharField(max_length=1,blank=True)
    ...
    parallelStructureDesignation = models.CharField(max_length=1,blank=True)
    directionOfTraffic = models.IntegerField(blank=True, null=True)
    temporaryStructureDesignation = models.CharField(max_length=1,blank=True)
    ...
    deckStructureType = models.CharField(max_length=1,blank=True)
    ...
    nbisBridgeLength = models.CharField(max_length=1,blank=True)
    scourCriticalBridges = models.CharField(max_length=1,blank=True)
    ...
    federalAgencyIndicator = models.CharField(max_length=1,blank=True)
    dateLastUpdate = models.CharField(max_length=10,blank=True)
    typeLastUpdate = models.CharField(max_length=1,blank=True)
    deductCode = models.CharField(max_length=1,blank=True)
    statuswith10yearrule = models.CharField(max_length=1,blank=True)
    sufficiencyRatingAsteriskField = models.CharField(max_length=2,blank=True)
    sufficiencyRating = models.IntegerField(blank=True, null=True)
